        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="col-span-2 ">
                <div class="p-3 sm:p-5 mb-5 bg-white border border-gray-200 shadow-sm rounded-2xl">
                    ...
                    <div class="mb-6 flex justify-between">
                        ...
                        <div>
                            <div class="inline-flex rounded-md shadow-sm" role="group">
                                ...
                                <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="mr-2 block text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" type="button">
                                Delete
                                </button>
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete {{$slope->slope_name}}?</h3>
                    ...
                    <div>
                        <div>
                            <div class="flex px-5 py-3 mb-4 rounded-lg bg-gray-50 border border-gray-200 hover:bg-gray-100 hover:border-lime-600">
                                <div class="w-full border-r border-gray-300">
                                    <div class="text-lg font-bold">Mitigation 12 June 2024</div>
                                ...
                                <div class="w-full md:block hidden text-center">
                                    ...
                                    <div class=" font-semibold">Farhan</div>
                                </div>
                            </div>
                        </div>
